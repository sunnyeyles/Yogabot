(function () {
  ...
  // Version 1.0 - Stable embed script
  const VERSION = "1.0.0";
  console.log(`Yoga Chatbot v${VERSION} loaded`);
  ...
  function initChatbot() {
    try {
      ...
      if (document.getElementById("yoga-chatbot-container")) {
        console.log("Yoga Chatbot: Already initialized");
        return;
      }
      ...
      console.log("Yoga Chatbot: Initialized successfully");
    } catch (error) {
      console.error("Yoga Chatbot: Initialization failed", error);
    }
  }
  ...
  window.YogaChatbotVersion = VERSION;
})();
